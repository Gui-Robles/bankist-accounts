...
const account2 = {
  ...
  movementsDates: [
    ...
    '2021-01-27T14:43:26.374Z',
    '2021-01-25T18:49:59.371Z',
...
const formatMovementData = function (date, locale) {
  ...
  const daysPast = calcDaysPassed(new Date(), date);
...
const startLogOtTimer = function () {
  ...
  //setting the timer to 2 mins
  let time = 120;
  //callthe timer every second
  tick();
  const timer = setInterval(tick, 1000);
  return timer;
  //after the timer expires stop timer and log out user
};
